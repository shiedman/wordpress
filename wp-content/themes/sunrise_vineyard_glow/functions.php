...
$themename = "LeadCamp";
$themesubname = "sunrise_vineyard_glow_lae092";
$themeversion = "2.23";
...
foreach ($options as $value) {
    if (get_option( $value['id'] ) === FALSE) { $$value['id'] = $value['std']; } else { 
    ...
    if($value['id'] == "lcmp_mnutohide"){
       if(get_option( $value['id'] ) === FALSE){
            ...
            $lcmp_mnutohide = get_option( $value['id'] );
       }
    }        
    if($value['id'] == "lcmp_footerhtml"){
       if(get_option( $value['id'] ) === FALSE){
            ...
            $themeFooter  = get_option( $value['id'] );
       }
    }
...
<form method="post">
<p class="submit">
<input class="button" name="reset" type="submit" value="Reset To Defaults" />
<input class="button" type="hidden" name="action" value="reset" />
</p>
</form>
<?php
}
...
<?php
	...
	foreach ($options as $value) {
        if (get_option( $value['id'] ) === FALSE) { $$value['id'] = $value['std']; } else { 
            $$value['id'] = html_entity_decode(get_option( $value['id'] )); 
        } 
        if($value['id'] == "lcmp_hdrimage"){
           if(get_option( $value['id'] ) !== FALSE){
                if(get_option( $value['id'] ) != 'default'){
                    echo "div.Header-jpeg{";
                    $image = get_option( $value['id'] );
        ...
        if($value['id'] == "lcmp_contentlnk"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_contentlnk  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_sidebarlnk"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_sidebarlnk  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstcontentlnk"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstcontentlnk  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstsidebarlnk"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstsidebarlnk  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_titlecolor"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_titlecolor  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_slogancolor"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_slogancolor  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_csttitlecolor"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_csttitlecolor  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstslogancolor"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstslogancolor  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_titlefontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_titlefontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_sloganfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_sloganfontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_csttitlefontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_csttitlefontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstsloganfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstsloganfontsize  = get_option( $value['id'] );
           }
        }
        ...
        if($value['id'] == "lcmp_hdrleftpos"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_hdrleftpos  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_hdrtoppos"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_hdrtoppos  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_hdrwidth"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_hdrwidth  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_hdrvmargin"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_hdrvmargin  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_contentfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_contentfontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstcontentfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstcontentfontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_sidebarloc"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_sidebarloc = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_sidebarfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_sidebarfontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstsidebarfontsize"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstsidebarfontsize  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgewidth"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgewidth  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgewidth1"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgewidth1  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgewidth2"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgewidth2  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgewidth3"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgewidth3  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgewidth4"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgewidth4  = get_option( $value['id'] );
           }
        }
        if($value['id'] == "lcmp_cstftrwidgemargin"){
           if(get_option( $value['id'] ) === FALSE){
                ...
                $lcmp_cstftrwidgemargin  = get_option( $value['id'] );
           }
        }
    }	    
